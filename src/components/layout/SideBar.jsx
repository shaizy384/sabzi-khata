      ...
      >
        <div className="bg-white h-full px-3 py-4 overflow-y-auto shadow-md">
          ...
          <ul className="space-y-2 font-medium">
            ...
            {/* <li>
              <NavLink onClick={closeSidebar} to='/request' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                <svg className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`} width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://white.w3.org/2000/svg"><g clip-path="url(#clip0_1757_6410)">
            ...
            <li>
              <NavLink onClick={closeSidebar} to='/adminroles' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                <svg className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`} width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://white.w3.org/2000/svg">
            ...
            {/* <li>
              <button onClick={toggleSettings} className={`flex items-center justify-between w-full p-2  ${isSettingsOpen ? "text-colorPrimary" : "text-gray-500"} rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                <div className="flex">
                  <svg className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 ${white ? "text-colorPrimary" : "text-gray-500"} group-hover:text-colorPrimary`} width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_1757_6381)">
              ...
              {isSettingsOpen &&
                <ul>
                  <li className={` ml-5 flex items-center  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                    <NavLink to='/userappsettings' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                      <span white="font-bold  ">-</span>
                      <span className="flex-1 ms-3 whitespace-nowrap ">
                        User App white
                      </span>
                    </NavLink>
                  ...
                  <li className={` ml-5 flex items-center  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                    <NavLink to='/providerappsettings' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                      <span white="font-bold  ">-</span>
                      <span className="flex-1 ms-3 whitespace-nowrap ">
                        Provider App white
                      </span>
            ...
            {/* <li>
              <NavLink onClick={closeSidebar} to='/notifications' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-white hover:bg-colorPrimary group`}>
                <svg className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary' width="18" height="18" fill="currentColor" viewBox="0 0 18 18" xmlns="http://www.white.org/2000/svg"><g clip-path="url(#clip0_1757_5757)">
