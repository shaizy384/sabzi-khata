      ...
      >
        <div className="bg-gray-900 h-full px-3 py-4 overflow-y-auto">
          ...
          <ul class="space-y-2 font-medium">
            ...
            {/* <li>
              <NavLink onClick={closeSidebar} to="/ordermanagement" className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg
                  className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <NavLink onClick={closeSidebar} to='/products' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg
                  className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {/* <li>
              <NavLink onClick={closeSidebar} to='/addsale' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg
                  className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <NavLink onClick={closeSidebar} to='/addpurchase' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg
                  className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {/* <li>
              <NavLink onClick={closeSidebar} to='/request' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`} width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_1757_6410)">
            ...
            <li>
              <NavLink onClick={closeSidebar} to='/adminroles' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`} width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <li>
              <button onClick={toggleSettings} className={`flex items-center justify-between w-full p-2  ${isSettingsOpen ? "text-colorPrimary" : "text-gray-500"} rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <div className="flex">
                  <svg className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 ${isSettingsOpen ? "text-colorPrimary" : "text-gray-500"} group-hover:text-colorPrimary`} width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_1757_6381)">
              ...
              {isSettingsOpen &&
                <ul>
                  <li className={` ml-5 flex items-center  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                    <NavLink to='/userappsettings' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                  ...
                  <li className={` ml-5 flex items-center  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                    <NavLink to='/providerappsettings' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                      <span className="font-bold  ">-</span>
                      <span className="flex-1 ms-3 whitespace-nowrap ">
            ...
            {/* <li>
              <NavLink onClick={closeSidebar} to='/notifications' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary' width="18" height="18" fill="currentColor" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_1757_5757)">
            ...
            <li>
              <NavLink onClick={closeSidebar} to='/supplierreport' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg
                  className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <NavLink onClick={closeSidebar} to='/customerreport' className={`flex items-center p-2  text-gray-500 rounded-lg hover:text-colorPrimary hover:bg-${secondaryColor} group`}>
                <svg
                  className={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-colorPrimary`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
