...
export default function BlockConfirmationModal({ id, type, person }) {
    ...
    return (
        <>
            {person?.status === 0 &&
                <div className="group">
                    <button className={`bg-green-600 items-center justify-between flex hover:bg-green-700 text-white  py-2 px-4 rounded`}
                        onClick={handleSubmit}
                    >
                        <svg className="mr-2 w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m6.072 10.072 2 2 6-4m3.586 4.314.9-.9a2 2 0 0 0 0-2.828l-.9-.9a2 2 0 0 1-.586-1.414V5.072a2 2 0 0 0-2-2H13.8a2 2 0 0 1-1.414-.586l-.9-.9a2 2 0 0 0-2.828 0l-.9.9a2 2 0 0 1-1.414.586H5.072a2 2 0 0 0-2 2v1.272a2 2 0 0 1-.586 1.414l-.9.9a2 2 0 0 0 0 2.828l.9.9a2 2 0 0 1 .586 1.414v1.272a2 2 0 0 0 2 2h1.272a2 2 0 0 1 1.414.586l.9.9a2 2 0 0 0 2.828 0l.9-.9a2 2 0 0 1 1.414-.586h1.272a2 2 0 0 0 2-2V13.8a2 2 0 0 1 .586-1.414Z" /></svg>
                        ACTIVATE
                    </button>
                    <div className="tooltip hidden group-hover:block  bg-white px-2 py-1 rounded absolute mt-2 mr-2 shadow-lg">
                        <h1 className='text-black bg-white rounded mb-2 mt-2'>
                            <span className='font-bold'>Press</span> to <span className='font-bold text-green-600'>ACTIVATE</span> {modalType}
                        </h1>
                    </div>
                </div>
            }
            {person?.status === 1 &&
                <div className="group">
                    ...
                    <div className="tooltip hidden group-hover:block bg-white px-2 py-1 rounded absolute mt-2 mr-2 shadow-lg">
                        {/* <h1 className='text-center bg-white border-2 border-green-600 px-2 py-1 rounded mt-2'>
                            Activated
                        </h1> */}
                        <h1 className='text-black bg-white rounded mb-2 mt-2'>
                            <span className='font-bold'>Press</span> to <span className='font-bold text-red-600'>SUSPEND</span> {modalType}
                        </h1>
                    </div>
                </div>
            }
