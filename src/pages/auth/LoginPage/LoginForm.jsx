    ...
    <div className="md:w-1/2 w-screen  bg-white h-screen flex justify-center items-center flex-col ">
      <div className="md:w-auto w-[85%]">
        ...
        <div className="md:mx-4">
          <h1 className="font-bold md:flex text-2xl text-slate-900 hidden">
            Sign In to your Account
          </h1>
          <h3 className="mt-2 text-slate-500 md:text-left text-center">
          ...
          <button className="font-bold mt-6 cursor-pointer group relative flex gap-1.5 justify-center py-4 bg-colorPrimary sm:w-96 w-full bg-opacity-80 text-white rounded-xl  hover:bg-hoverPrimary hover:shadow-lg transition " onClick={() => { dispatch(login()); navigate("/dashboard") }}>
            Sign In
          </button>
